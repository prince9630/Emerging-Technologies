...
nmea_file_path = r"C:\Users\princ\PycharmProjects\Assignment_3\gps_data.nmea"
...
def mqtt_send_data(args):
    ...
    ca_filepath = r"C:\Users\princ\PycharmProjects\Assignment_3\Certificates\AmazonRootCA1.pem"
    cert_filepath = r"C:\Users\princ\PycharmProjects\Assignment_3\Certificates\certificate.pem.crt.crt"
    key_filepath = r"C:\Users\princ\PycharmProjects\Assignment_3\Certificates\private.pem.key.key"
    ...
    command_topic = f"{topic}/cmd"
    mqtt_connection.subscribe(topic=command_topic, qos=mqtt.QoS.AT_LEAST_ONCE, callback=handle_command)
...
def handle_command(topic, payload, **kwargs):
    global exit_main
